...
class Stm32HalL4(ConanFile):
    ...
    options = ["hal_module_enabled": [True, False],
               ...
               "hse_value": [True, False],
               "hse_startup_timeout": [True, False],
               "msi_value": "any",
               "hsi_value": "any",
               "lsi_value": "any",
               "lse_value": "any",
    ...
    default_options = ["hal_module_enabled" = False,
    ...
    def requirements(self):
        ...
        self.requires(
            f"stm_cmsis_core/5.6.0_cm4@{project_username}/{project_channel}")
        self.requires(
            f"stm_cmsis_device_l4/1.7.1@{project_username}/{project_channel}")
